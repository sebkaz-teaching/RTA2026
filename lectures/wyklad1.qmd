...
Analiza danych w czasie rzeczywistym (ang. *Real-Time Data Analytics*) to **proces** przetwarzania i analizy danych natychmiast po ich wygenerowaniu, bez konieczności przechowywania i oczekiwania na późniejsze przetworzenie. 
Celem jest uzyskanie **natychmiastowych** wniosków i reakcji na zmieniające się warunki w systemach biznesowych, technologicznych i naukowych.
...
W dzisiejszej gospodarce informacja ma swoją "datę ważności". 
Przejście z trybu Batch na Real-Time drastycznie skraca czas od wystąpienia zdarzenia do podjęcia decyzji (Time-to-Insight). 
Dla menedżera oznacza to możliwość natychmiastowej reakcji na działania konkurencji lub nagłe zmiany popytu, co bezpośrednio przekłada się na wyższą płynność finansową i lepsze dopasowanie oferty do klienta.