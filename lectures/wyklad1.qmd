...
description: "Ewolucja modeli przetwarzania danych — od prostych plików, przez bazy relacyjne i hurtownie danych, aż po Data Lake i przetwarzanie strumieniowe."
format:
  html:
    code-fold: true
    code-tools: true
...
: Przykłady zastosowań real-time analytics {.striped .hover}
...
```{mermaid}
%%| fig-cap: "Ewolucja modeli przetwarzania danych"
timeline
...
#| fig-cap: "Porównanie trybów przetwarzania: opóźnienie vs koszt"
...
## Big Data — pięć wymiarów (5V) {.unnumbered}
