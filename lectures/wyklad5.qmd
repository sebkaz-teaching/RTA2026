...
```{mermaid}
%%| fig-cap: "Ekosystem Apache Spark"
flowchart TB
...
```{mermaid}
%%| fig-cap: "Structured Streaming: strumień jako nieograniczona tabela"
flowchart TB
...
```{mermaid}
%%| fig-cap: "Kompletny pipeline real-time analytics — podsumowanie kursu"
flowchart LR
