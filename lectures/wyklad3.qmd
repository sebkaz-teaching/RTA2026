...
description: "Uczenie wsadowe vs przyrostowe, SGD, concept drift, detekcja anomalii i wyjaśnialność modeli."
format:
  html:
    code-fold: true
    code-tools: true
...
#| fig-cap: "SGD vs Batch GD — zbieżność i wynik dopasowania"
...
#| fig-cap: "Concept drift: model batch vs online — dokładność w czasie"
